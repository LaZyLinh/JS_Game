class Barrier {
	...
	constructor() {
		...
		this.width = 20;		// starting width of column
	}
	...
	render() {
		...
		rectMode(CORNERS);
		rect(this.xPos-20, -50, this.xPos+this.width, this.yPos-this.gap/2);
		rect(this.xPos-20, height+50, this.xPos+this.width, this.yPos+this.gap/2);
